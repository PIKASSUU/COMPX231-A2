...
class ReadersWritersMonitor:
    ...
    def start_read(self, reader_id: int) -> None:
        ...
        with self.condition:
            ...
            print(
                f"Reader {reader_id} starts reading. Active readers: {self.active_readers}")
    ...
    def end_read(self, reader_id: int) -> None:
        ...
        with self.condition:
            ...
            self.active_readers -= 1
            print(
                f"Reader {reader_id} ends reading. Active readers: {self.active_readers}")
    ...
    def start_write(self, writer_id: int) -> None:
        ...
        with self.condition:
            ...
            print(
                f"Writer {writer_id} starts writing. Active writers: {self.active_writers}")
    ...
    def end_write(self, writer_id: int) -> None:
        ...
        with self.condition:
            ...
            self.active_writers -= 1
            print(
                f"Writer {writer_id} ends writing. Active writers: {self.active_writers}")
            self.condition.notify_all()
